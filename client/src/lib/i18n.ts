...
const resources = {
  ro: {
    translation: {
      ...
      terms_introduction_text: "Prin utilizarea site-ului nostru web, confirmați că ați citit, înțeles și sunteți de acord să respectați acești Termeni și Condiții. Dacă nu sunteți de acord cu acești termeni, vă rugăm să nu utilizați site-ul nostru.",
      terms_use_heading: "Utilizarea Site-ului",
      terms_use_text: "Site-ul StilClas este destinat utilizării personale și necomerciale. Este interzisă utilizarea site-ului pentru activități ilegale sau neautorizate. Ne rezervăm dreptul de a restricționa accesul oricărui utilizator în cazul încălcării acestor termeni.",
      terms_intellectual_property_heading: "Proprietate Intelectuală",
      terms_intellectual_property_text: "Toate materialele prezentate pe acest site, inclusiv texte, imagini, design, logo-uri și conținut, sunt proprietatea StilClas și sunt protejate de legile drepturilor de autor și de proprietate intelectuală. Este interzisă reproducerea, distribuirea sau modificarea acestora fără acordul nostru explicit.",
      terms_user_accounts_heading: "Conturi de Utilizator",
      terms_user_accounts_text: "Când creați un cont pe site-ul nostru, sunteți responsabil pentru menținerea confidențialității informațiilor de autentificare și pentru toate activitățile care au loc sub contul dumneavoastră. Vă rugăm să ne notificați imediat despre orice utilizare neautorizată a contului dumneavoastră.",
      terms_products_heading: "Produse",
      terms_products_text: "Facem eforturi pentru a prezenta cât mai precis produsele noastre, inclusiv culorile, dimensiunile și detaliile. Cu toate acestea, nu putem garanta că afișarea pe ecranul dispozitivului dumneavoastră va fi exactă. Toate produsele sunt supuse disponibilității.",
      terms_reservations_heading: "Rezervări",
      terms_reservations_text: "Prin efectuarea unei rezervări pe site-ul nostru, confirmaţi că sunteți de acord să vizitați magazinul nostru în perioada specificată pentru a vedea produsul și a finaliza achiziția. Rezervările sunt valabile pentru perioada specificată și pot fi anulate dacă nu vă prezentați în această perioadă.",
      terms_liability_heading: "Limitarea Răspunderii",
      terms_liability_text: "StilClas nu este responsabilă pentru daune directe, indirecte, accidentale sau consecvente care rezultă din utilizarea sau incapacitatea de a utiliza site-ul nostru sau serviciile noastre.",
      terms_governing_law_heading: "Legislație Aplicabilă",
      terms_governing_law_text: "Acești termeni și condiții sunt guvernate de legile României. Orice dispută legată de site-ul nostru va fi soluționată în instanțele din România.",
      terms_changes_heading: "Modificări ale Termenilor",
      terms_changes_text: "Ne rezervăm dreptul de a modifica acești termeni în orice moment. Modificările intră în vigoare imediat după publicarea pe site. Utilizarea continuă a site-ului după aceste modificări constituie acceptarea noilor termeni.",
      terms_contact_heading: "Contact",
      terms_contact_text: "Dacă aveți întrebări despre Termenii și Condițiile noastre, vă rugăm să ne contactați prin pagina de Contact sau la adresa de email afișată pe site.",
      terms_last_updated: "Ultima actualizare",
      terms_last_updated_date: "20 mai 2024",
      
      // Privacy Policy Page
      privacy_introduction: "La StilClas, respectăm confidențialitatea dumneavoastră și ne angajăm să protejăm datele personale. Această Politică de Confidențialitate explică cum colectăm, utilizăm și protejăm informațiile dumneavoastră când utilizați site-ul nostru.",
      privacy_information_collection_heading: "Informații pe care le colectăm",
      privacy_information_collection_text: "Putem colecta diferite tipuri de informații atunci când utilizați site-ul nostru, vă înregistrați pentru un cont sau efectuați o rezervare.",
      ...
      privacy_personal_data_address: "Adresă (pentru livrare sau facturare)",
      privacy_usage_data_heading: "Date de utilizare",
      privacy_usage_data_text: "Colectăm automat informații despre cum interacționați cu site-ul nostru, cum ar fi paginile vizitate, timpul petrecut pe site, produsele vizualizate și informații despre dispozitivul dumneavoastră.",
      privacy_data_use_heading: "Cum utilizăm datele dumneavoastră",
      privacy_data_use_text: "Utilizăm datele dumneavoastră personale pentru următoarele scopuri:",
      privacy_data_use_process_reservations: "Pentru a procesa și gestiona rezervările dumneavoastră",
      privacy_data_use_provide_service: "Pentru a vă oferi serviciile noastre și pentru a răspunde întrebărilor dumneavoastră",
      privacy_data_use_communications: "Pentru a vă trimite comunicări despre produsele și serviciile noastre (cu acordul dumneavoastră)",
      privacy_data_use_improve_service: "Pentru a îmbunătăți site-ul nostru și serviciile oferite",
      privacy_data_retention_heading: "Retenția datelor",
      privacy_data_retention_text: "Păstrăm datele dumneavoastră personale atât timp cât este necesar pentru a îndeplini scopurile pentru care au fost colectate, inclusiv pentru a satisface cerințele legale sau de raportare.",
      privacy_data_security_heading: "Securitatea datelor",
      privacy_data_security_text: "Implementăm măsuri de securitate adecvate pentru a proteja datele dumneavoastră împotriva accesului neautorizat, modificării, divulgării sau distrugerii.",
      privacy_cookies_heading: "Cookie-uri",
      privacy_cookies_text: "Site-ul nostru utilizează cookie-uri pentru a îmbunătăți experiența utilizatorului. Puteți controla utilizarea cookie-urilor prin setările browserului dumneavoastră.",
      privacy_third_party_heading: "Partajarea cu terți",
      privacy_third_party_text: "Nu vindem, nu comercializăm și nu transferăm datele dumneavoastră personale unor terțe părți, cu excepția cazului în care avem permisiunea dumneavoastră sau suntem obligați legal să facem acest lucru.",
      privacy_childrens_privacy_heading: "Confidențialitatea copiilor",
      privacy_childrens_privacy_text: "Site-ul nostru nu este destinat copiilor sub 16 ani și nu colectăm cu bună știință date personale de la copii.",
      privacy_changes_heading: "Modificări ale politicii de confidențialitate",
      privacy_changes_text: "Putem actualiza periodic această politică de confidențialitate. Vă încurajăm să revizuiți această pagină pentru cele mai recente informații despre practicile noastre de confidențialitate.",
      privacy_contact_heading: "Contact",
      privacy_contact_text: "Dacă aveți întrebări despre Politica noastră de Confidențialitate, vă rugăm să ne contactați prin pagina de Contact sau la adresa de email afișată pe site.",
      privacy_last_updated: "Ultima actualizare",
      privacy_last_updated_date: "20 mai 2024",
      
      // FAQ Page
      faq_intro: "Aici găsiți răspunsuri la cele mai frecvente întrebări despre produsele și serviciile noastre. Dacă nu găsiți răspunsul la întrebarea dvs., nu ezitați să ne contactați.",
      faq_category_general: "Informații Generale",
      faq_general_q1: "Ce este StilClas?",
      faq_general_a1: "StilClas este un brand premium de îmbrăcăminte pentru bărbați, specializat în costume, sacouri și accesorii de înaltă calitate. Suntem dedicați excelenței în croitorie, folosind materiale premium și tehnici tradiționale pentru a crea piese elegante și durabile.",
      faq_general_q2: "Unde se află magazinul fizic StilClas?",
      faq_general_a2: "Magazinul nostru principal se află în București, dar avem și locații în Cluj-Napoca și Timișoara. Consultați pagina noastră de Contact pentru adresele exacte și programul de funcționare.",
      faq_general_q3: "Care este programul de funcționare al magazinelor?",
      faq_general_a3: "Magazinele noastre sunt deschise de luni până vineri între orele 10:00 și 20:00, sâmbătă între 10:00 și 18:00, și duminică între 10:00 și 16:00. Programul poate varia în perioada sărbătorilor.",
      faq_category_products: "Produse",
      faq_products_q1: "Ce tipuri de produse oferă StilClas?",
      faq_products_a1: "Oferim o gamă completă de îmbrăcăminte formală pentru bărbați, inclusiv costume, sacouri, pantaloni, cămăși, precum și accesorii precum cravate, papioane, butoni și curele. Toate produsele noastre sunt realizate din materiale premium, cu o atenție deosebită la detalii.",
      faq_products_q2: "Cum pot afla mărimea potrivită pentru mine?",
      faq_products_a2: "Fiecare produs din magazinul nostru online include un ghid detaliat de mărimi. Pentru o potrivire perfectă, vă recomandăm să vizitați unul dintre magazinele noastre pentru o consultare personalizată și măsurători profesionale.",
      faq_products_q3: "Produsele pot fi personalizate?",
      faq_products_a3: "Da, oferim servicii de personalizare pentru majoritatea produselor noastre. Puteți solicita ajustări pentru o potrivire perfectă sau modificări de design pentru a crea o piesă unică. Aceste servicii sunt disponibile în magazinele noastre fizice.",
      faq_products_q4: "Care este diferența între costumele de ceremonie și cele de business?",
      faq_products_a4: "Costumele de ceremonie sunt concepute pentru ocazii speciale, cum ar fi nunți sau evenimente formale, și prezintă adesea detalii distinctive și materiale premium. Costumele de business sunt create pentru uz profesional, cu un accent pe confort și durabilitate pentru purtare zilnică.",
      faq_category_reservations: "Rezervări",
      faq_reservations_q1: "Cum funcționează sistemul de rezervare online?",
      faq_reservations_a1: "Sistemul nostru de rezervare vă permite să selectați produsele dorite online și să le rezervați pentru a le încerca în magazin. Completați formularul de rezervare cu detaliile dumneavoastră și preferințele de vizitare, iar un consultant vă va pregăti produsele pentru când ajungeți.",
      faq_reservations_q2: "Cât timp este valabilă o rezervare?",
      faq_reservations_a2: "Rezervările sunt valabile timp de 7 zile de la data confirmării. Dacă nu puteți ajunge în această perioadă, vă rugăm să ne contactați pentru a reprograma vizita.",
      faq_reservations_q3: "Există vreun cost pentru efectuarea unei rezervări?",
      faq_reservations_a3: "Nu, serviciul de rezervare este complet gratuit. Plătiți doar dacă decideți să achiziționați produsele după ce le încercați în magazin.",
      faq_category_shipping: "Livrare",
      faq_shipping_q1: "Care sunt opțiunile de livrare disponibile?",
      faq_shipping_a1: "Oferim livrare în toată România prin curier, cu opțiuni standard (2-3 zile lucrătoare) și express (24-48 ore). De asemenea, există opțiunea de ridicare personală din magazinele noastre.",
      faq_shipping_q2: "Cât costă livrarea?",
      faq_shipping_a2: "Livrarea standard este gratuită pentru comenzi peste 500 RON. Pentru comenzi sub această valoare, taxa de livrare este de 20 RON. Livrarea express are un cost suplimentar de 15 RON.",
      faq_category_returns: "Returnări și Garanții",
      faq_returns_q1: "Care este politica de returnare?",
      faq_returns_a1: "Acceptăm returnări în termen de 14 zile de la primirea produsului, cu condiția ca articolele să fie în starea originală, cu etichetele atașate și ambalajul original. Costurile de returnare sunt suportate de client, cu excepția cazurilor în care produsul prezintă defecte.",
      faq_returns_q2: "Ce garanție oferă produsele StilClas?",
      faq_returns_a2: "Toate produsele noastre beneficiază de o garanție de 24 de luni care acoperă defectele de fabricație. Această garanție nu acoperă uzura normală sau daunele cauzate de utilizarea necorespunzătoare.",
      faq_returns_q3: "Cum pot face o reclamație sau returna un produs?",
      faq_returns_a3: "Pentru a returna un produs sau a face o reclamație, vă rugăm să contactați serviciul nostru clienți prin email sau telefon. Veți primi instrucțiuni detaliate despre procesul de returnare și documentele necesare.",
      faq_contact_text: "Nu ați găsit răspunsul la întrebarea dvs.? Contactați-ne direct la",
  ...
  en: {
    translation: {
      ...
      terms_introduction_text: "By using our website, you confirm that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our site.",
      terms_use_heading: "Use of the Site",
      terms_use_text: "The StilClas website is intended for personal, non-commercial use. You are prohibited from using the site for any illegal or unauthorized activities. We reserve the right to restrict access for any user who violates these terms.",
      terms_intellectual_property_heading: "Intellectual Property",
      terms_intellectual_property_text: "All materials on this site, including text, images, design, logos, and content are the property of StilClas and are protected by copyright and intellectual property laws. Reproduction, distribution, or modification without our explicit consent is prohibited.",
      terms_user_accounts_heading: "User Accounts",
      terms_user_accounts_text: "When creating an account on our site, you are responsible for maintaining the confidentiality of your login information and for all activities that occur under your account. Please notify us immediately of any unauthorized use of your account.",
      terms_products_heading: "Products",
      terms_products_text: "We make efforts to present our products as accurately as possible, including colors, dimensions, and details. However, we cannot guarantee that the display on your device will be accurate. All products are subject to availability.",
      terms_reservations_heading: "Reservations",
      terms_reservations_text: "By making a reservation on our site, you confirm that you agree to visit our store within the specified period to view the product and complete the purchase. Reservations are valid for the specified period and may be canceled if you do not show up during this period.",
      terms_liability_heading: "Limitation of Liability",
      terms_liability_text: "StilClas is not liable for any direct, indirect, incidental, or consequential damages resulting from your use of or inability to use our site or services.",
      terms_governing_law_heading: "Governing Law",
      terms_governing_law_text: "These terms and conditions are governed by the laws of Romania. Any dispute related to our site will be resolved in the courts of Romania.",
      terms_changes_heading: "Changes to Terms",
      terms_changes_text: "We reserve the right to modify these terms at any time. Changes are effective immediately upon posting to the site. Your continued use of the site after such changes constitutes acceptance of the new terms.",
      terms_contact_heading: "Contact",
      terms_contact_text: "If you have any questions about our Terms and Conditions, please contact us through the Contact page or at the email address displayed on the site.",
      terms_last_updated: "Last updated",
      terms_last_updated_date: "May 20, 2024",
      
      // Privacy Policy Page
      privacy_introduction: "At StilClas, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and safeguard your information when you use our website.",
      privacy_information_collection_heading: "Information We Collect",
      privacy_information_collection_text: "We may collect various types of information when you use our website, register for an account, or make a reservation.",
      ...
      privacy_personal_data_address: "Address (for delivery or billing)",
      privacy_usage_data_heading: "Usage Data",
      privacy_usage_data_text: "We automatically collect information about how you interact with our website, such as pages visited, time spent on the site, products viewed, and information about your device.",
      privacy_data_use_heading: "How We Use Your Data",
      privacy_data_use_text: "We use your personal data for the following purposes:",
      privacy_data_use_process_reservations: "To process and manage your reservations",
      privacy_data_use_provide_service: "To provide our services and respond to your inquiries",
      privacy_data_use_communications: "To send you communications about our products and services (with your consent)",
      privacy_data_use_improve_service: "To improve our website and services",
      privacy_data_retention_heading: "Data Retention",
      privacy_data_retention_text: "We retain your personal data for as long as necessary to fulfill the purposes for which it was collected, including to satisfy legal or reporting requirements.",
      privacy_data_security_heading: "Data Security",
      privacy_data_security_text: "We implement appropriate security measures to protect your data against unauthorized access, alteration, disclosure, or destruction.",
      privacy_cookies_heading: "Cookies",
      privacy_cookies_text: "Our website uses cookies to enhance the user experience. You can control the use of cookies through your browser settings.",
      privacy_third_party_heading: "Third-Party Sharing",
      privacy_third_party_text: "We do not sell, trade, or transfer your personal data to third parties unless we have your permission or are legally required to do so.",
      privacy_childrens_privacy_heading: "Children's Privacy",
      privacy_childrens_privacy_text: "Our website is not intended for children under 16 years of age, and we do not knowingly collect personal data from children.",
      privacy_changes_heading: "Changes to Privacy Policy",
      privacy_changes_text: "We may periodically update this privacy policy. We encourage you to review this page for the latest information about our privacy practices.",
      privacy_contact_heading: "Contact",
      privacy_contact_text: "If you have questions about our Privacy Policy, please contact us through the Contact page or at the email address displayed on the site.",
      privacy_last_updated: "Last updated",
      privacy_last_updated_date: "May 20, 2024",
      
      // FAQ Page
      faq_intro: "Here you'll find answers to the most frequently asked questions about our products and services. If you don't find the answer to your question, please don't hesitate to contact us.",
      faq_category_general: "General Information",
      faq_general_q1: "What is StilClas?",
      faq_general_a1: "StilClas is a premium menswear brand, specializing in high-quality suits, blazers, and accessories. We are dedicated to excellence in tailoring, using premium materials and traditional techniques to create elegant and durable pieces.",
      faq_general_q2: "Where is the StilClas physical store located?",
      faq_general_a2: "Our main store is located in Bucharest, but we also have locations in Cluj-Napoca and Timișoara. Check our Contact page for exact addresses and operating hours.",
      faq_general_q3: "What are the store operating hours?",
      faq_general_a3: "Our stores are open Monday to Friday from 10:00 AM to 8:00 PM, Saturday from 10:00 AM to 6:00 PM, and Sunday from 10:00 AM to 4:00 PM. Hours may vary during holidays.",
      faq_category_products: "Products",
      faq_products_q1: "What types of products does StilClas offer?",
      faq_products_a1: "We offer a complete range of formal menswear, including suits, blazers, trousers, shirts, as well as accessories such as ties, bow ties, cufflinks, and belts. All our products are made from premium materials, with careful attention to detail.",
      faq_products_q2: "How can I find the right size for me?",
      faq_products_a2: "Each product in our online store includes a detailed size guide. For a perfect fit, we recommend visiting one of our stores for a personalized consultation and professional measurements.",
      faq_products_q3: "Can products be customized?",
      faq_products_a3: "Yes, we offer customization services for most of our products. You can request adjustments for a perfect fit or design modifications to create a unique piece. These services are available in our physical stores.",
      faq_products_q4: "What is the difference between ceremony and business suits?",
      faq_products_a4: "Ceremony suits are designed for special occasions such as weddings or formal events and often feature distinctive details and premium materials. Business suits are created for professional use, with an emphasis on comfort and durability for daily wear.",
      faq_category_reservations: "Reservations",
      faq_reservations_q1: "How does the online reservation system work?",
      faq_reservations_a1: "Our reservation system allows you to select the desired products online and reserve them to try on in-store. Fill out the reservation form with your details and visiting preferences, and a consultant will prepare the products for when you arrive.",
      faq_reservations_q2: "How long is a reservation valid?",
      faq_reservations_a2: "Reservations are valid for 7 days from the date of confirmation. If you cannot make it within this period, please contact us to reschedule your visit.",
      faq_reservations_q3: "Is there a cost for making a reservation?",
      faq_reservations_a3: "No, the reservation service is completely free. You only pay if you decide to purchase the products after trying them on in-store.",
      faq_category_shipping: "Shipping",
      faq_shipping_q1: "What shipping options are available?",
      faq_shipping_a1: "We offer delivery throughout Romania via courier, with standard (2-3 business days) and express (24-48 hours) options. There is also an option for personal pickup from our stores.",
      faq_shipping_q2: "How much does shipping cost?",
      faq_shipping_a2: "Standard shipping is free for orders over 500 RON. For orders below this value, the shipping fee is 20 RON. Express shipping has an additional cost of 15 RON.",
      faq_category_returns: "Returns and Warranties",
      faq_returns_q1: "What is the return policy?",
      faq_returns_a1: "We accept returns within 14 days of receiving the product, provided that the items are in their original condition, with tags attached and original packaging. Return costs are borne by the customer, except in cases where the product is defective.",
      faq_returns_q2: "What warranty do StilClas products have?",
      faq_returns_a2: "All our products come with a 24-month warranty covering manufacturing defects. This warranty does not cover normal wear and tear or damage caused by improper use.",
      faq_returns_q3: "How can I make a complaint or return a product?",
      faq_returns_a3: "To return a product or make a complaint, please contact our customer service via email or phone. You will receive detailed instructions about the return process and the necessary documents.",
      faq_contact_text: "Didn't find the answer to your question? Contact us directly at",
