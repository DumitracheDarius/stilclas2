  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      <div className="relative">
        ...
        <div
          className="absolute inset-0 rounded-full bg-[#25D366] opacity-20 animate-pulse"
        ...
        <motion.a
          ...
          style={{
            boxShadow:
              "0 10px 25px -5px rgba(37, 211, 102, 0.5), 0 8px 10px -6px rgba(0, 0, 0, 0.1)",
          }}
          whileHover={{
            scale: 1.1,
            boxShadow:
              "0 20px 25px -5px rgba(37, 211, 102, 0.6), 0 10px 10px -5px rgba(0, 0, 0, 0.1)",
          }}
          whileTap={{ scale: 0.95 }}
